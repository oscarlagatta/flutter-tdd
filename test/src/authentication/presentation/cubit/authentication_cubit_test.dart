...
void main() {
  ...
  // After each test we close the cubit
  tearDown(() => cubit.close());

  // Test the initial state
  test('initial state should be [AuthenticationInitial]', () async {
    // We don't need any arrangements or acting
    // because the cubit already lives (cubit)

    expect(cubit.state, const AuthenticationInitial());
  });

  group('createUser', () {
    // we test the cubit but we use blocTest
