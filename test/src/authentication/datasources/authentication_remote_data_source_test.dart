...
void main() {
  ...
  group('createUser', () {
    ...
    test(
        'should throw API exception when status cod is not 200 '
        'or 201', () async {
      when(
        () => client.post(any(),
            body: any(named: 'body'),
  ...
  group('getUsers', () {
    ...
    test('should return [List<User>] when the status code is 200 or 201',
        () async {
      when(
        () => client.get(any()),
      ).thenAnswer(
    ...
    test('should throw [APIException] when the status code is not 200',
      ...
      when(
        ...
        (_) async => http.Response('Server down, Server down', 500),
      );
      ...
      expect(
        ...
        throwsA(
          const APIException(
              message: 'Server down, Server down', statusCode: 500),
        ),
      );
